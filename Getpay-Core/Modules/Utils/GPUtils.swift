...
public class GPUtils {
    ...
    public static func loadAccountPersistenceFromUD() -> GPAccount {
        ...
        return GPAccount(id: 0, status: "", number: "", branchNumber: "", aliasAccountStatus: "", institution: GPBankingInstitution(number: 0, name: ""), balance: GPAccountBalance(id: 0, withdrawAvailableBalance: 0, globalAvailableBalance: 0), hasCard: false)
    }
